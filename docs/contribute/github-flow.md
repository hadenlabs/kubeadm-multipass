...
<!-- Title: Contributing GithubFlow KubeadmMultipass -->
...
To contribute to kubeadm-multipass project on [GitHub](https://github.com/hadenlabs/kubeadm-multipass), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/kubeadm-multipass/pulls).
...
```bash
git remote add upstream  https://github.com/hadenlabs/kubeadm-multipass.git
```

Now your **upstream** points to **hadenlabs/kubeadm-multipass**.
...
git fetch upstream # assuming upstream is hadenlabs/kubeadm-multipass
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/kubeadm-multipass/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
